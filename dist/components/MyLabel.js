...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", __assign({ className: "label ".concat(size, " text-").concat(color), style: { color: fontColor, backgroundColor: backgroundColor, padding: '0.25em 0.5em' } }, { children: allCaps ? label.toUpperCase() : label }), void 0));
};
